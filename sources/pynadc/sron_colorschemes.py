...
def add_outlier_colors(cdict):
    ...
    for k in "red", "green", "blue":
        colorspec = cdict[k]
        first_entry = (0.0, OutlierBelowRangeColor[k],OutlierBelowRangeColor[k])
        last_entry  = (1.0, OutlierAboveRangeColor[k],OutlierAboveRangeColor[k])
        new_colorspec = tuple([first_entry] + list(colorspec) + [last_entry])
        new_cdict[k] = new_colorspec
